...
-- Create indexes
CREATE INDEX IF NOT EXISTS "AdContainer_gameId_idx" ON "AdContainer"("gameId");
CREATE INDEX IF NOT EXISTS "AdContainer_currentAdId_idx" ON "AdContainer"("currentAdId");
CREATE INDEX IF NOT EXISTS "AdEngagement_containerId_idx" ON "AdEngagement"("containerId");
CREATE INDEX IF NOT EXISTS "AdEngagement_adId_idx" ON "AdEngagement"("adId");

-- Add foreign key constraints
ALTER TABLE "AdContainer" 
DROP CONSTRAINT IF EXISTS "AdContainer_gameId_fkey",
ADD CONSTRAINT "AdContainer_gameId_fkey" 
FOREIGN KEY ("gameId") REFERENCES "Game"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "AdContainer" 
DROP CONSTRAINT IF EXISTS "AdContainer_currentAdId_fkey",
...
DROP CONSTRAINT IF EXISTS "AdEngagement_containerId_fkey",
